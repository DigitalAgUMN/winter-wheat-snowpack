...
def process(model_name):
    base_dir = os.path.join("N:/WinterWheat/model-input-swe-bc-shift", model_name)
    ...
    output_dir = "N:/WinterWheat/county_map/v20210911-shift+15"

    output_dir = os.path.join(output_dir, model_name)
    data_filename = os.path.join(base_dir, "winter_wheat_input_igdd_sdepth_bc_v20210903_{}_shift+15.csv".format(model_name))
