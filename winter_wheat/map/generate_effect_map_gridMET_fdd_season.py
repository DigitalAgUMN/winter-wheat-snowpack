...
if __name__ == "__main__":
    ...
    # df = pd.read_csv(os.path.join(base_dir, "winter_wheat_input_ifdd_season_v20201028_gridUS.csv"))
    df = pd.read_csv(os.path.join(base_dir, "winter_wheat_input_ifdd_season_v20210107_gridUS_4km.csv"))
