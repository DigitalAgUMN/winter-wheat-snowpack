...
def process(model_name):
    base_dir = os.path.join("N:/WinterWheat/model-input", model_name)
    ...
    data_filename = os.path.join(base_dir, "winter_wheat_input_fdd_season_v20210109_{}.csv".format(model_name))
