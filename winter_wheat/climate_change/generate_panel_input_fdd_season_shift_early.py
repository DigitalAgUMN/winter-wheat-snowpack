...
def generate_panel_output(output_filename, df_all):
    ...
    #     "fdd1"], 0)
    df_all["fdd1_fall"] = np.where(((df_all["monthday"] >= 817) & (df_all["monthday"] <= 1115)), df_all[
        "fdd1"], 0)
    df_all["fdd1_winter"] = np.where(((df_all["monthday"] >= 1116) | (df_all["monthday"] <= 214)), df_all[
        "fdd1"], 0)
    df_all["fdd1_spring"] = np.where(((df_all["monthday"] >= 215) & (df_all["monthday"] <= 516)), df_all[
        "fdd1"], 0)
